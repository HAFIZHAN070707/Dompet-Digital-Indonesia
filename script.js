...
window.addEventListener('popstate', function(event) {
  if (window.location.hash === '#pin') {
    // Masih di halaman PIN, kembali ke input nomor
    resetToHome();
    history.replaceState(null, '', ' '); // hapus #pin dari URL
  } else {
    // Sudah di input nomor, back lagi = keluar ke danakaget.html
    window.location.href = 'danakaget.html';
  }
});
